...
help = {"#project":{
          ...
          "content":"Cliquez sur le bouton 'Add a new project' et donnez un nom à votre projet",
          "placement":"bottom",
          "position": "inside",
          },
        "#corpus":{
          ...
          "content": "<p>Pour ajouter un corpus à votre projet"+
                      ...
                      "<h4><span class='glyphicon glyphicon-hand-right'></span> Si vous avez déjà un fichier à téléverser :</h4>"+
                      "<ol><li>Vérifier que votre fichier est <a href=''>compressé (archive .zip) </a> et dans le bon <a href='https://iscpif.fr/gargantext/import-formats'>format</a></li>"+
                      "<li>Cliquez sur 'Choisir un fichier...'</li>"+
                      "<li>Puis donnez un nom à votre corpus</li>"+
                      "<li>Cliquez sur 'Process this!'</li></ol>"+
                      "<h4><span class='glyphicon glyphicon-hand-right'></span> Si vous souhaitez importer un corpus directement depuis une base de donnée ouverte :</h4>"+
                      "<ol><li>Sélectionnez l'option No à la question Do you have a file already?</li>"+
